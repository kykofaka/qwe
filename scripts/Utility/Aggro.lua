...
Aggro.aggroKey = Menu.AddKeyOption({"MrGarabato", "Utility",  "Aggro/Deaggro"}, "Aggro Key", Enum.ButtonCode.KEY_8)
Aggro.deaggroKey = Menu.AddKeyOption({"MrGarabato", "Utility",  "Aggro/Deaggro"}, "Deaggro Key", Enum.ButtonCode.KEY_9)
